...
import { useGetSingleUserWithdrawListQuery } from "../../../API/Users/Withdraw/withdrawSlice";

const WithdrawHistory = () => {
  const { user } = useContext(AuthContext);
  const { data: singleUserWithdrawList, isLoading } =
    useGetSingleUserWithdrawListQuery(user?._id, {
        ...
        <div className="max-w-[90vw] md:max-w-[100vw] mx-auto overflow-x-scroll">
          <table className="min-w-full divide-y divide-gray-500 mt-5 rounded">
            ...
            <tbody className="divide-y divide-gray-500">
              {singleUserWithdrawList?.data?.map((data, i) => (
                <tr key={i}>

...
const BotTable = () => {
  ...
  const apiUrl = `https://stock-back.vercel.app/api/v1/trade/find?tradeType=bot&result=pending`;

  const handleBotTrade = () => {
    axios
      .post(apiUrl, postBotData, { headers })
      .then((res) => {
                ...
                {currentItems?.map((tbody, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-2">
                        <div className="text-left font-montserrat text-base font-normal">
                          <span className="bg-green-100 lowercase text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">
                            {tbody?.email}
                          </span>
                        </div>
                      </td>
                      <td className="px-2">
                        <div className="text-left font-montserrat text-base font-normal">
                          <span className="bg-yellow-100 capitalize text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">
                            {tbody?.tradeType}
                          </span>
                        </div>
                      </td>

...
const TablePagination = ({
    ...
    if (number < maxPageNumberLimit + 1 && number > minPageNumberLimit) {
      return (
        <li
          ...
          className={
            currentPage === number
              ? "pr-auto flex h-8 w-8 items-center justify-center rounded-full border bg-primary p-2 text-lg font-semibold"
  ...
  const noDataFound = (
    <div
      role="status"
      className="w-full h-96 animate-pulse flex justify-center items-center flex-col"
    >
      <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-full h-full mb-4"></div>

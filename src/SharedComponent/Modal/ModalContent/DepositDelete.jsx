...
import { useUpdateDeleteDepositMutation } from "../../../API/Users/userDeposit/UserDepositSlice";

const DepositDelete = ({ id, setModalOpen, name }) => {
  const [updateDeleteDeposit, { isLoading }] =
    useUpdateDeleteDepositMutation();

  const confirmDelete = async (e) => {
    e.preventDefault();
    const res = await updateDeleteDeposit({ id });
    if (res.error) {

...
const PhotoModal = ({ title, modalOpen, setModalOpen, modalContent, setModalContent }) => {
  ...
  return (
    <div className={`${modalOpen === true ? "block" : "hidden"}`}>
      ...
      {/* Modal dialog */}
      <Transition
        className="fixed inset-0 top-[30px] z-50 flex transform items-start justify-center overflow-hidden"
        role="dialog"
        aria-modal="true"
        show={modalOpen}
      ...
      >
        <div
          ref={modalContentRef}
          className={`h-[570px] w-11/12 max-w-[450px] rounded-2xl bg-secondBackground py-5`}
        >

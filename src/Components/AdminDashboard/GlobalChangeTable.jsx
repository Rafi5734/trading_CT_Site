...
import GlobalChangeDelete from "../../SharedComponent/Modal/ModalContent/GlobalChangeDelete";
import GlobalChangeContent from "./Content/GlobalChangeContent";
const GlobalChangeTable = ({ pageTitle, changeFont, tableHead, tableData }) => {
  ...
  const handleDelete = (id) => {
    setModalTitle("Delete Global Data");
    setSmallModalOpen(true);
    setModalContent(
      <GlobalChangeDelete setModalOpen={setSmallModalOpen} id={id} />
    );
  };
                  ...
                  {currentItems?.map((tbody, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2">
                          <div className="text-left font-montserrat text-base font-normal">
                            <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
                              {tbody?.adminWalletAddress.slice(0, 20) + ".."}
                            </span>
                          </div>
                        </td>
                        <td className="px-2">
                        ...
                        <td className="px-2">
                          <div className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
                            <p>
                              $  {tbody?.marketCapital}
                            </p>
                          </div>
                        ...
                        <td className="px-2">
                          <div className="text-left capitalize font-montserrat text-sm font-medium">
                            <p
                              className={`${"text-green-800 dark:bg-green-900 dark:text-green-300"} rounded-full px-2 text-center py-0.5`}
                            >
                              {tbody?.change}
                            </p>
                          </div>
                        ...
                        <td className="px-2">
                          <div className="text-left capitalize font-montserrat text-sm font-medium">
                            <p
                              className={`${"text-blue-800 dark:bg-blue-900 dark:text-blue-300"} rounded-full px-2 text-center py-0.5`}
                            >
                              {tbody?.tradeReturn}
                            </p>
                          </div>
...
export default GlobalChangeTable;
